...
function ListaProductos({ productos }) {
  const { agregarProducto } = useContext(CarritoContext); // usamos el global que ya muestra el mensaje
  ...
  const agregarAlCarrito = (producto) => {
    agregarProducto(producto); // esto ya activa el mensaje desde el contexto
  };
            ...
            <div className="card h-100 shadow-sm border-0 rounded-3" style={{ fontSize: '0.85rem' }}>
              ...
              <div className="card-body d-flex flex-column text-center">
                ...
                <p className="card-text text-muted mb-3">
                  <strong>Ocupación:</strong> {producto.ocupacion || producto.info?.Ocupación || 'N/A'}<br />
